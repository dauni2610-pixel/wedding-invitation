    ...
    <section className="flex flex-col items-center gap-8 bg-sage-50 px-8 py-20">
      ...
      <Reveal delay={0.15} className="grid w-full grid-cols-4 gap-2">
        {UNITS.map((unit) => (
          <div
            key={unit.key}
            className="flex flex-col items-center gap-1 rounded-lg border border-sage-200 bg-parchment py-4 shadow-sm"
          >
            <span className="font-display text-2xl tabular-nums text-sage-700">
